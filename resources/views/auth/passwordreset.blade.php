    ...
    <section class="vh-100">
        <div class="container-fluid h-custom">
            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                ...
                @endif
                <br>
                <form id="form_acesso" action="{{ route('Password/New') }}" method="POST">
                @csrf
                @method("POST")
                <!-- Email input -->
                <input type="hidden" name="TokenPW" value="{{$Token->token}}">
                ...
                <div class="form-outline mb-4">
                    ...
                    <input type="password" name="confirm_password" class="form-control form-control-lg" required placeholder="Senha" />
                </div>
